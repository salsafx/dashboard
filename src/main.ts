...
buildChart('chart-dc', [48, 52, 55, 58, 61, 63, 65, 66, 68, 69, 70, 71, 70, 71, 72, 71, 72, 73, 72, 71, 72, 72, 73, 72], '#a78bfa', '#2e1065', 100);
...
buildChart('chart-pitch', [8, 10, 12, 14, 18, 22, 25, 28, 30, 32, 33, 34, 35, 34, 35, 36, 35, 34, 35, 35, 36, 35, 35, 35], '#14b8a6', '#042f2e', 90);
buildChart('chart-blade1', [8, 10, 12, 15, 18, 22, 26, 28, 30, 32, 33, 34, 35, 34, 35, 36, 35, 34, 35, 35, 36, 35, 34, 35], '#14b8a6', '#115e59', 90);
buildChart('chart-blade2', [7, 9, 11, 14, 17, 20, 24, 26, 28, 30, 31, 32, 32, 31, 32, 33, 32, 31, 32, 32, 33, 32, 32, 32], '#2dd4bf', '#115e59', 90);
buildChart('chart-torque', [20, 28, 35, 42, 48, 54, 58, 62, 65, 67, 68, 70, 71, 70, 71, 72, 71, 72, 73, 72, 71, 72, 72, 72], '#f59e0b', '#431407', 100);
buildChart('chart-gen', [48, 50, 52, 55, 58, 60, 63, 65, 67, 69, 70, 72, 73, 74, 75, 76, 76, 77, 77, 78, 78, 78, 77, 78], '#fda4af', '#4c0519', 120);
buildChart('chart-amps', [180, 240, 280, 340, 390, 430, 470, 510, 540, 560, 580, 590, 600, 610, 620, 625, 628, 630, 631, 629, 630, 631, 632, 632], '#38bdf8', '#082f49', 800);
buildChart('chart-pf', [88, 90, 91, 92, 93, 94, 94, 95, 95, 96, 96, 97, 97, 97, 98, 97, 98, 98, 97, 98, 98, 98, 97, 98], '#2dd4bf', '#042f2e', 100);
buildChart('chart-q', [2, 3, 4, 5, 6, 6, 7, 7, 8, 8, 8, 9, 9, 8, 9, 9, 8, 9, 9, 9, 8, 9, 9, 9], '#84cc16', '#1a2e05', 12);
